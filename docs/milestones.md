...
- Astro-Projektgrundlage mit Cloudflare-Adapter.
- `wrangler.jsonc` mit D1- und R2-Bindings.
- Datengetriebenes Layout, Navigation, Startseite und Footer.
- Teams fuer Herren, Senioren, Jugend/JSG Nord und Darts.
...
- vollstaendige Inhaltsmigration der Altseite.
- R2-Medienverwaltung mit Uploadvalidierung und Thumbnails.
- Sponsorenverwaltung.
- Downloadsverwaltung.
- Benutzer- und Rechteverwaltung.
- Team-Redakteure.
- geplante News.
- Suche und weitere SEO-Optimierung.
